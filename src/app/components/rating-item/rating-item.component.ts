...
`,
    providers: [
        { provide: NG_VALUE_ACCESSOR, useExisting: forwardRef(() => RatingItemComponent), multi: true },
        { provide: NG_VALIDATORS, useExisting: forwardRef(() => RatingItemComponent), multi: true },
    ],
    styles: [`
span.rating {
    cursor: pointer;
...
export class RatingItemComponent implements OnInit, ControlValueAccessor, Validator {
